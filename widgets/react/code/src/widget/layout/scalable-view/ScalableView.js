...
export default class ScalableView extends Component {
  // 设置属性值
  static propTypes = {
  ...
  _calcScaleRatio() {
    ...
    const deviceAspectRatio = this.state.deviceWidth / this.state.deviceHeight;

    // 计算传入的视觉稿的比
    const visualAspectRatio = this.visualWidth / this.visualHeight;
